...
def main():
    with sync_playwright() as p:
        ...
        page.screenshot(path='final_01_students_page.png')
        print("  ✅ 截图: final_01_students_page.png")
        ...
        if container.count() > 0:
            ...
            if 670 <= width <= 674:
                ...
                print(f"  ⚠️ 宽度: {width}px (预期: 672px)")
        ...
        if header.count() > 0:
            ...
            if bg_color == 'rgb(26, 26, 26)' and text_color == 'rgb(255, 255, 255)':
                ...
                print(f"  ❌ Header 颜色不正确")
                print(f"     预期: 背景=rgb(26, 26, 26), 文字=rgb(255, 255, 255)")
        else:
            print("  ⚠️ 未找到 header 元素")
        ...
        page.screenshot(path='final_02_student_added.png')
        print("  ✅ 截图: final_02_student_added.png")
        ...
        page.screenshot(path='final_03_all_visible.png')
        print("  ✅ 截图: final_03_all_visible.png")
        ...
        page.screenshot(path='final_04_edit_modal.png')
        print("  ✅ 截图: final_04_edit_modal.png")
